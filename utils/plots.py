...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    midpointbox = (int((c1[0] + c2[0]) / 2), int((c1[1] + c2[1]) / 2)) #Coordinate of center of bounding box
    ...
    if label:
        ...
        cv2.putText(img, label, (c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA) #Labeling
    return [label,midpointbox]
